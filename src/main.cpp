...
PYBIND11_MODULE(PokerPy, m) {
    ...
    // m.def("get_best_hand", &poker_algo_old::get_best_hand_not_sorted, "A function that gets the best hands given 7 cards", py::return_value_policy::move);
    ...
    // m.def("get_best_hand_new", &poker_algo_new::get_best_hand_not_sorted, "A function that gets the best hands given 7 cards", py::return_value_policy::move);
    ...
    // ////
    // m.def("nice_print_frequencies", &nice_print_frequencies, "A function that gets the frequencies of the possible hands and prints them in nice format", py::return_value_policy::move);
}
